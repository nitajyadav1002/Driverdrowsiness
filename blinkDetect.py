...
FACE_DOWNSAMPLE_RATIO = 1.25#1.5
RESIZE_HEIGHT = 460

thresh = 0.27
modelPath = "models/shape_predictor_70_face_landmarks.dat"
#audio_path = "C:\\Users\\premy\\Music\\Computer-Vision-Project-Driver-drowsiness-detection-Full-code-explanation-OpenCV-Python-Dlib-main\\alarm.wav"

#sound_path = "C:\Users\premy\Music\Computer-Vision-Project-Driver-drowsiness-detection-Full-code-explanation-OpenCV-Python-Dlib-main\alarm.wav"
sound_path = r"C:\Users\premy\Music\Computer-Vision-Project-Driver-drowsiness-detection-Full-code-explanation-OpenCV-Python-Dlib-main\alarm.wav"
...
def soundAlert(sound_path, thread_status_queue):
    pygame.mixer.init()
    pygame.mixer.music.load(sound_path)
    pygame.mixer.music.play()
    while True:
        if not thread_status_queue.empty() and thread_status_queue.get():
